...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className={`relative isolate [contain:layout_style] [perspective:600px] transition-transform  duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform  [aspect-ratio:17/28]`}
      ref={refElement}
      onPointerMove={(event) => {
